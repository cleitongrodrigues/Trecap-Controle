...
module.exports = {
    async ListarEndereco(request, response) {
        try {
            ...
            endereco_bairro, endereco_cidade, endereco_estado, endereco_cep, endereco_tipo, entidade_id
            FROM Endereco;`;
    ...
    async CadastrarEndereco(request, response) {
        try {
            const { endereco_logradouro, endereco_numero, endereco_complemento, 
                endereco_bairro, endereco_cidade, endereco_estado, endereco_cep, endereco_tipo, entidade_id } = request.body;
    ...
    async EditarEndereco(request, response) {
        try {
            ...
            const values = [endereco_logradouro, endereco_numero, endereco_complemento, 
                endereco_bairro, endereco_cidade, endereco_estado, endereco_cep, endereco_tipo, entidade_id, endereco_id];
